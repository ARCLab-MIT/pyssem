...
We would recomment starting with the `pyssem/example-sim.json` file, which is a simulation presented by [Miles Lifson at AMOS 2023](https://amostech.com/TechnicalPapers/2023/Poster/Lifson.pdf). We would recommend using this as a template and then updating the parameters as desired. 
