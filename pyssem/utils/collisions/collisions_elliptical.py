...
def evolve_bins(scen_properties, m1, m2, r1, r2, v1, v2, binE_mass, binE_ecc, collision_index, n_shells=0):
        ...
        # if you know the altitude, sma and eccentricity - you can calculate the true anomaly
        # from the TA and ecc, you can calculate the flight path angle
        # FPA is 0 is in track, 90 is in radial, -90 is in the negative radial vector direction
        # you can then calculate speed from radius and semi-major axus
        # assume y is in track direction. Velocity vector is v*sin(FPA), v*cos(FPA), 0
