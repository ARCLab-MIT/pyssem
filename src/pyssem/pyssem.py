from utils.simulation.scen_properties import SceneProperties
...
scen_properties = SceneProperties(datetime.strptime('01/06/2023', "%m/%d/%Y"), 
...
launch = scen_properties.launch_func()
...
# Drag
#drag = drag_func(0, species_properties, scen_properties)
